...
local sceneGroup = self.view
    ...
    elseif ( phase == "did" ) then
        ...
        timer1 = timer.performWithDelay( 1000, decrementar, 30 )
...
function scene:hide( event )
    ...
    elseif ( phase == "did" ) then
        ...
        -- Eliminamos todos los elementos que muestran si el jugador gano o perdio para poder reiniciar el juego
        display.remove( win )
